...
export -x LIBRARY_PATH="$LIBRARY_PATH:${extra_lib_dir}/usr/lib64/"
export -x LD_LIBRARY_PATH="$LD_LIBRARY_PATH:${extra_lib_dir}/usr/lib64/"
export -x C_INCLUDE_PATH="$C_INCLUDE_PATH:${extra_lib_dir}/usr/include/"
